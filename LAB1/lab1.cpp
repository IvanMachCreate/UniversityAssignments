...
{
    /*
        There are 1 errors in total. Can you catch them all? :)
    ...
    */
    ...
    cout << "Welcome to the exciting, fun, and awesome programming world! "
         << "Enter an even number, and I can tell something about you! " << endl;
    cin >> number; 
 
    if (number % 2 != 0)
        cout << "Hmm... this is not an even number..." << endl;
    else
    {
        if (number < 0)
